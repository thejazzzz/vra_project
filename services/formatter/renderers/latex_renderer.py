...
class LatexRenderer:
    ...
    def render(report: FormattedReport) -> bytes:
        ...
        lines.append(r"\title{\textbf{" + LatexRenderer._escape(report.title) + "}}")
        
        authors_str = ", ".join(report.authors)
        lines.append(r"\author{" + LatexRenderer._escape(authors_str) + r" \\ \small \textit{Generated by AI Researcher - Automated Report}}")
